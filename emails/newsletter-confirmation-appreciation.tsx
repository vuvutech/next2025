      ...
      <Tailwind>
        <Body className="bg-white text-black font-sans">
          <Container className="my-10 px-6 py-8 border rounded-md shadow-md max-w-xl">
            ...
            <Text className="text-sm leading-6">
              <strong>Thank you for subscribing</strong> to the{" "}
              <strong>COSTrAD Newsletter</strong>!
            </Text>

            <Text className="text-sm leading-6">
              We're excited to have you on board. You’ll now receive regular
              updates, insights, and research straight from the COSTrAD team.
            </Text>

            <Text className="text-sm leading-6 mt-4">
              If at any time you have questions or feedback, we’d love to hear
              from you.
            </Text>
            ...
            {unsubscribeToken && (
              <Text className="text-[11px] text-muted mt-4">
                ...
                unsubscribe at any time by clicking{" "}
                <Link
