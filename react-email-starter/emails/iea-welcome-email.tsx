        ...
        <Body className="mx-auto my-auto bg-[#fdfdfd] px-2 font-sans text-[#333333]">
          <Container className="mx-auto my-[40px] max-w-[900px] bg-white p-[20px] border border-solid border-[#eaeaea] rounded">
            ...
            <Text className="text-[14px] leading-[24px]">
              ...
              Sustainable Transformation and Development (COSTrAD) and its Presidency.
            </Text>
            ...
            <Section className="bg-[#f9f9f9] border-l-4 border-solid border-[#0056b3] p-[15px] my-[20px]">
              ...
              <Text className="m-0 text-[14px] leading-[24px]">
                <strong>Dates:</strong> The institute is scheduled for June 8–13, {currentYear}, via a dedicated online
                platform.
              </Text>
            </Section>
