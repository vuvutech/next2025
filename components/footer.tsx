...
const footerLinks = [
	...
	},
	{
		...
		links: [
			...
			{
				label: "College of Sustainable Transformation and Development (COSTrAD) ",
			...
			<div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-14  pt-8 border-t '>
				<div className='grid grid-cols-1  md:grid-cols-5 gap-10 mb-10'>
					{footerLinks.map((section) => (
						...
						>
							<h3 className='text-sm sm:text-xl mb-4 '>
								{section.title}
							</h3>
				...
				<div className='mt-6 text-xs sm:text-center space-y-2  '>
					...
					<p className='max-w-6xl font-light font-opensans  sm:text-center mx-auto text-[9px] md:text-[12px] uppercase  pt-4'>
						The College of Sustainable Transformation and
						Development — COSTrAD™ — functions as an academic and
						development-oriented institution that operates under the
						umbrella and direction of the Logos-Rhema Foundation.
						This foundation is a legally recognized and fully
						registered Non-Profit Organization that is committed to
						driving sustainable change through education, research,
						and community engagement. It holds the official
						registration number{" "}
						<span className='text-primary '>CG046792017</span>, as
						recorded under the regulatory framework and legal
						statutes of the Republic of Ghana.
					</p>
				</div>
			</div>
		</footer>
