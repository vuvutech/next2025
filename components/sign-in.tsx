...
export default function SignInComponent({
  ...
  const callbackUrl = costradCallbackUrl || searchParams.get("callbackUrl") || "/";
      ...
      <CardContent className="py-5">
        ...
        <Form {...form}>
          <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4">
            ...
            {turnstileError && (
              <p className="text-destructive text-sm text-center font-medium">{turnstileError}</p>
            )}
      ...
      <CardFooter>
        {displayFooterText && (
          <div className="text-xs text-muted-foreground leading-relaxed">
            ...
            <Link href="/auth/sign-up" className="font-bold text-foreground hover:underline">
              Sign Up
            </Link>
            <br />
