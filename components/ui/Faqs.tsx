...
export default function CostradFaqs() {
	const faqData = [
		...
		},
		{
			key: "2",
			question:
				"What makes COSTrAD different from traditional higher education institutions?",
			answer:
		...
		},
		{
			key: "5",
			question:
				"What skills does COSTrAD emphasize for its transformational leaders?",
			answer:
		...
		},
		{
			key: "7",
			question:
				"Is COSTrAD affiliated with any religious or faith-based principles?",
			answer:
