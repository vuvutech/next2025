				...
				<div className='grid grid-cols-3 md:h-[50dvh]  w-full flex-col gap-16 overflow-hidden rounded-xl bg-accent p-4 sm:p-8 md:rounded-xl lg:flex-row lg:items-center lg:p-16'>
					<div className='col-span-full md:col-span-2 '>
						...
						<p className='text-foreground lg:text-lg'>
							Stay in the loop and never miss out on what's
							happening! Be the first to hear about our latest and
							most exciting events, special announcements,
							important updates, and exclusive notifications—all
							sent directly to you. Join us and make sure you're
							always up to date with everything we have going on.
						</p>
					</div>
