		...
		<div className="flex justify-between md:items-end relative ">
			...
			<div className="w-full md:flex items-center justify-between">
				...
				<div className="flex items-center gap-10">
					<Link
						target="_blank"
						href={"https://gh.linkedin.com/in/abu-bako-69a65718"}
					>
						LinkedIn
					</Link>
					<Link target="_blank" href={"https://www.facebook.com/drabubako/"}>
						Facebook
					</Link>
					<Link
						target="_blank"
						href={"https://twitter.com/drabubako/status/980861107891032065"}
					>
						X
					</Link>
				</div>
...
const Nav = () => {
	return (
		<div className="flex flex-col h-auto md:flex-row items-start shrink-0 gap-8 md:gap-20 z-50 pt-5 md:pt-[14dvh]">
			...
			<div className="flex flex-col ">
				<h3 className="mb-2 uppercase md:text-2xl text-gray-500">
					Affiliations
				</h3>
