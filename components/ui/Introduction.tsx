...
const Introduction = () => {
	return (
		<div className=" container mx-auto max-w-5xl grid grid-cols-1 md:grid-cols-3 gap-4 min-h-screen h-auto space-y-3 p-4  md:p-12 ">
			...
			>
				<div className={" text-gray-500 text-3xl uppercase font-light"}>
					An Overview
				</div>
				<div className="w-1/3 text-red-500">&#8212;</div>
				<div className={`${bebas.className} pb-4 md:leading-[3.7rem] `}>
				...
				<Image
					...
					height={250}
					alt="COSTrAD"
					className="rounded-3xl md:pr-4"
				/>
			</div>
			<div className="md:col-span-2 md:text-xl space-y-2  ">
				<p>
					This book, <span className="text-red-500">"COSTrAD Volume 1"</span> by
					Dr. Abu Bako, is a valuable resource that equips readers with the
					knowledge and skills necessary to make informed decisions at the
					polls. Written by a renowned expert in leadership and governance, the
					book provides practical guidance on how to become an active and
					responsible citizen, leveraging one's vote as a tool for co-ruling
					with God.
				</p>
				<br />
				<p>
