	...
	return (
		<div className="space-y-3">
			...
			<section className=" mx-auto ">
				...
				<div
					id="begin"
					className="border-gray-500/20 gap-4 grid md:border md:gap-8 md:items-center md:p-2 rounded-3xl xl:gap-20"
				>
					<div className="sm:p-4 md:p-8 space-y-5">
						...
						<p className="mt-3 text-current  max-w-5xl">
							...
							p.m. GMT (UTC+0 / Accra Time), and we would be happy to assist you
					...
					<div
						className="min-h-[35vh] bg-center bg-cover bg-no-repeat relative rounded-2xl md:min-h-[75vh]"
						style={{
