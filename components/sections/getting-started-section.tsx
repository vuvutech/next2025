	...
	const steps = [
		{
			...
			description:
				"Sign up to access COSTrAD’s leadership platform. It’s your first step toward a transformative learning journey. Use a valid email to register and unlock courses, resources, and your spot in the community.",
		...
		},
		{
			...
			description:
				"Fill out your profile with current and accurate information. This helps us match you with the right institute and improves your approval chances.",
			mobileImage: "/images/reviews.jpg",
			desktopImage: "/images/steps2.jpg",
		},
		{
			...
			description:
				"Browse our specialized institutes in leadership, governance, and transformation. Pick one that fits your goals — spots fill up fast, so choose early.",
			mobileImage: "/images/reviews.jpg",
			desktopImage: "/images/steps2.jpg",
		},
		{
			...
			description:
				"Your application will be reviewed after submission. If approved, you’ll receive onboarding details and can begin your COSTrAD journey.",
			mobileImage: "/images/reviews.jpg",
			desktopImage: "/images/steps2.jpg",
		},
	];
