...
const variantStyles = {
	...
	warning: {
		...
		accent: "border-l-warning/30",
	},
	info: {
		iconBg: "bg-info/10",
		iconColor: "text-info",
		accent: "border-l-info/30",
	},
};
...
export function KpiCard({
	...
	return (
		<Card
			className={`relative overflow-hidden border-l-4 ${styles.accent} transition-all duration-200 hover:shadow-sm`}
		>
			<CardContent className="p-4">
				<div className="flex items-start justify-between">
					...
					<div
						className={`flex size-9 shrink-0 items-center justify-center rounded-lg ${styles.iconBg} ${styles.iconColor}`}
					>
				...
				{trend && (
					<div
						className={`mt-2 flex items-center gap-1 text-xs font-medium ${trendColors[trend.direction]}`}
					>
