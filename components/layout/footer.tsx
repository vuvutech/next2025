				...
				<footer className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-14  pt-14 border-t ">
					...
					>
						...
						<p className="max-w-6xl font-light font-opensans  sm:text-center mx-auto text-[9px] md:text-[12px] uppercase  pt-4">
							...
							Logos-Rhema Foundation. This foundation is a legally recognized
							and fully registered Non-Profit Organization that is committed to
							...
							under the regulatory framework and legal statutes of the Republic
							of Ghana.
						</p>
					</motion.div>
				</footer>
