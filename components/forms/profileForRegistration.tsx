			...
			<CardContent>
				<form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
					<div className="text-sm text-foreground bg-muted/30 p-3 rounded-md border border-muted">
						<strong>Privacy Notice:</strong> All information you provide will be
						treated with the highest level of confidentiality. It will never be
						shared with third parties and is used strictly to ensure we provide
						the best possible support for your participation in our programs.
					</div>
