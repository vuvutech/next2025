	...
	return (
		<div className="max-w-7xl mx-auto  md:p-8  space-y-6">
			...
			<FadeIn as="section" className="">
				...
				<p>
					COSTrAD is committed to protecting the privacy and security of our
					members and visitors to our website. This Privacy Policy explains how
					we collect, use, and protect your personal information when you
					interact with us online and offline. By using our website or services,
			...
			<FadeIn as="section" className="">
				...
				<ul className="list-disc list-inside space-y-3 indent-[2%]">
					...
					<li>
						<strong>Membership Information</strong>: Details provided during the
						membership application process, including professional background
			...
			<FadeIn as="section" className="">
				...
				<ul className="list-disc list-inside space-y-3 indent-[2%]">
					<li>
						...
						business, or providing services to you, under strict confidentiality
						agreements.
					</li>
					<li>
			...
			<FadeIn as="section" className="">
				...
				<p>
					...
					your experience. You can manage your cookie preferences through your
