  ...
  return (
		<div className='sm:space-y-4'>
			...
			>
				...
				equipped to bring systemic and sustainable change, to every
				sphere of society.
			</FadeIn>
			<AboutSectionThree />
			...
			>
				We teach you the necessary skills and qualities to effectively
				lead and manage people, organizations, and systems.{" "}
				<span className='text-purple-700'>Leaders</span> must possess
				strong communication, decision-making, and{" "}
				<span className='text-chart-2'>problem-solving skills</span>, as
