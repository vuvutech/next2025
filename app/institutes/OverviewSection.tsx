...
export default function OverviewSection({
	...
	const formattedEndDate = endDate ? formatAccraDate(endDate) : "";

	const formattedEarlyBirdDeadline = earlyBirdDeadline
		? formatAccraDate(earlyBirdDeadline)
		: "";
	return (
		<section
			id="about-section"
									...
									new Date(earlyBirdDeadline) > new Date() ? (
										...
										<div>
											...
											<p className="mt-3 text-sm text-gray-500 dark:text-gray-400">
												Offer ends {formatAccraDate(earlyBirdDeadline)}
											</p>
										</div>
									) : (
										...
										<div>
											...
											{earlyBirdDeadline && earlyBirdPrice != null && (
												<p className="mt-3 text-sm text-gray-500 dark:text-gray-400">
