...
export const Section1 = ({
	...
	const formattedStartDate = edition?.startDate
		? formatAccraDate(edition.startDate)
		: "Coming Soon";
	const formattedEndDate = edition?.endDate
		? formatAccraDate(edition.endDate)
		: "";
	...
	return (
		<section className="bg-background container mx-auto  h-auto">
			<div className="relative flex flex-col items-center px-0! lg:pt-4">
				<DottedDiv>
					<div className="grid lg:grid-cols-3">
						...
						<DottedDiv className="group size-full md:cols-span-1 place-self-end p-4 ">
							<div
								id="begin"
								className="relative h-full min-h-svh w-full bg-muted-2/50 p-4 transition-all ease-in-out group-hover:bg-muted-2"
							>
								<Image
