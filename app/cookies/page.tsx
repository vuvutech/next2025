	...
	return (
		<div className="max-w-7xl mx-auto  md:p-8  space-y-6">
			...
			<FadeIn as="section" className="">
				...
				<p>
					COSTrAD is committed to ensuring the privacy and security of our
					website visitors. This Cookie Policy explains how we use cookies and
					similar tracking technologies on our website to enhance your user
					experience and provide you with relevant content and services.
				</p>
			</FadeIn>
			...
			<FadeIn as="section" className="">
				...
				<p>
					...
					Cookies can be "persistent" (which remain on your device until they
					expire or are deleted) or "session" (which are deleted when you close
					your browser).
				</p>
			</FadeIn>
			...
			<FadeIn as="section" className="">
				...
				<ul className="list-disc list-inside space-y-3 indent-[2%]">
					<li>
						...
						They are typically set in response to actions such as setting your
					...
					<li>
						...
						your interests. They may also be used to limit the number of times
						you see an advertisement and to help measure the effectiveness of
			...
			<FadeIn as="section" className="">
				...
				<ul className="list-disc list-inside space-y-3 indent-[2%]">
					<li>
						<strong>Improving User Experience</strong>: Cookies help us remember
						your preferences and settings, such as your language and region.
					</li>
					<li>
						<strong>Analyzing Site Usage</strong>: Cookies help us understand
						how visitors use our site, which pages are popular, and how to
						improve our services.
					</li>
					<li>
						<strong>Enhancing Security</strong>: Cookies help us protect your
						account and prevent unauthorized access.
					</li>
					<li>
						<strong>Providing Personalized Content</strong>: Cookies help us
						show you content and advertisements that are more relevant to your
						interests.
					</li>
				</ul>
			</FadeIn>
			...
			<FadeIn as="section" className="">
				...
				<p>
					You can manage cookies through your browser settings. Most web
			...
			<FadeIn as="section" className="">
				...
				<p>
					Our website may use third-party services that set cookies on your
				...
				<ul className="list-disc list-inside space-y-3 indent-[2%]">
					...
					<li>
						<strong>Advertising Networks</strong>: To deliver targeted
						advertisements.
					</li>
				</ul>
			</FadeIn>
			...
			<FadeIn as="section" className="">
				...
				<p>
					...
					of any significant changes by posting the new Cookie Policy on our
