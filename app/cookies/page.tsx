			...
			<div className="max-w-7xl mx-auto  md:p-8  space-y-6">
				...
				<FadeIn as="section" className="">
					...
					<p>
						...
						expire or are deleted) or "session" (which are deleted when you
						close your browser).
					</p>
				</FadeIn>
				...
				<FadeIn as="section" className="">
					...
					<ul className="list-disc list-inside space-y-3 indent-[2%]">
						<li>
							...
							systems. They are typically set in response to actions such as
				...
				<FadeIn as="section" className="">
					...
					<ul className="list-disc list-inside space-y-3 indent-[2%]">
						<li>
							<strong>Improving User Experience</strong>: Cookies help us
				...
				<FadeIn as="section" className="">
					...
					<p>
						...
						you of any significant changes by posting the new Cookie Policy on
