...
const navItems: NavItem[] = [
  {
    ...
    theme: {
      ...
      border: "border-blue-500/20 dark:border-blue-500/10 group-hover:border-blue-500/30",
  ...
  },
  {
    ...
    theme: {
      ...
      border: "border-emerald-500/20 dark:border-emerald-500/10 group-hover:border-emerald-500/30",
  ...
  },
  {
    ...
    theme: {
      ...
      border: "border-violet-500/20 dark:border-violet-500/10 group-hover:border-violet-500/30",
  ...
  },
  {
    ...
    theme: {
      ...
      border: "border-amber-500/20 dark:border-amber-500/10 group-hover:border-amber-500/30",
  ...
  },
  {
    ...
    theme: {
      ...
      border: "border-rose-500/20 dark:border-rose-500/10 group-hover:border-rose-500/30",
  ...
  },
  {
    ...
    theme: {
      ...
      border: "border-cyan-500/20 dark:border-cyan-500/10 group-hover:border-cyan-500/30",
  ...
  },
  {
    ...
    theme: {
      ...
      border: "border-fuchsia-500/20 dark:border-fuchsia-500/10 group-hover:border-fuchsia-500/30",
  ...
  },
  {
    ...
    theme: {
      ...
      border: "border-indigo-500/20 dark:border-indigo-500/10 group-hover:border-indigo-500/30",
  ...
  },
  {
    ...
    theme: {
      ...
      border: "border-teal-500/20 dark:border-teal-500/10 group-hover:border-teal-500/30",
        ...
        <div className="flex flex-col gap-6 md:flex-row md:items-center md:justify-between">
          <div className="space-y-3">
            ...
            <p className="max-w-xl text-sm text-muted-foreground leading-relaxed">
              Here's the latest performance and activity status across the COSTrAD platform. Check notifications and manage integrations below.
            </p>
          </div>
          ...
          {pendingApprovals > 0 && (
            <div className="shrink-0">
              ...
              >
                ...
                <div>
                  <div className="text-xs font-medium text-muted-foreground">Action Required</div>
        ...
        <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
          {navItems.map((item) => {
            ...
            return (
              ...
              >
                <Card className={`h-full border border-border/80 bg-card/60 backdrop-blur-xs transition-all duration-300 hover:-translate-y-1 hover:border-primary/25 ${item.theme.glow}`}>
                  <CardHeader className="flex flex-row items-start gap-4 p-5">
                    <div className={`flex size-11 shrink-0 items-center justify-center rounded-xl border transition-all duration-300 ${item.theme.bg} ${item.theme.text} ${item.theme.border} group-hover:scale-105`}>
