			...
			<div className="grid grid-cols-1 text-center gap-6 sm:gap-4 lg:gap-8">
				<div>
					...
					<p className="text-md mt-2 text-gray-600 dark:text-gray-400">
						This usually happens when the confirmation token is missing,
						invalid, or expired.
					</p>
					<p className="text-md mt-2 text-gray-600 dark:text-gray-400">
						If you believe this is an error, feel free to contact us directly
				...
				<div>
					<p className="text-sm text-center text-gray-600 dark:text-gray-400">
						...
						,{" "}
						<Link
							href="mailto:webmaster@costrad.org"
							className="underline hover:text-blue-600 dark:hover:text-blue-400"
							prefetch={false}
						>
