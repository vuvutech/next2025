				...
				<div className=" text-left w-full  md:p-8  sm:rounded-lg prose-img:rounded-xl max-w-max  prose dark:prose-invert ">
					...
					<div className="post-body post-content space-y-4">
						...
						<p>
							...
							will post a notification on the main page of the Website. We
						...
						<p>
							<strong>DMCA Agent:</strong> [Name or Department, e.g., "Copyright
							Department"]
							<br />
							<strong>Email:</strong>{" "}
						...
						<p>
							...
							<a
								href="https://www.costrad.org/contact"
								target="_blank"
								rel="noopener"
							>
								contact form
